...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = dp14rxss
 PARAMETER DRIVER_VER = 6.0
 PARAMETER HW_INSTANCE = dp_rx_hier_0_v_dp_rxss1_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.1
 PARAMETER HW_INSTANCE = dp_rx_hier_0_vid_edid_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vphy
 PARAMETER DRIVER_VER = 1.10
 PARAMETER HW_INSTANCE = dp_rx_hier_0_vid_phy_controller_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.1
 PARAMETER HW_INSTANCE = dp_rx_hier_0_video_frame_crc_0
END
