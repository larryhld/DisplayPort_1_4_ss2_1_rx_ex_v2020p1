...
HD_PWD='C:/Projects/Xilinx/DisplayPort/DisplayPort_1_4_ss2_1_rx_ex_v2020p1/hw/v_dp_rxss1_0_ex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dpss_zcu102_rx_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dpss_zcu102_rx_wrapper.tcl -notrace
