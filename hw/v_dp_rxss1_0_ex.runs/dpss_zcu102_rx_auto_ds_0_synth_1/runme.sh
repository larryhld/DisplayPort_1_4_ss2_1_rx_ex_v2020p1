...
HD_PWD='C:/Projects/Xilinx/DisplayPort/DisplayPort_1_4_ss2_1_rx_ex_v2020p1/hw/v_dp_rxss1_0_ex.runs/dpss_zcu102_rx_auto_ds_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dpss_zcu102_rx_auto_ds_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dpss_zcu102_rx_auto_ds_0.tcl
