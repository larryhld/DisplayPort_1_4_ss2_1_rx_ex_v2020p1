...
--               c:/Projects/Xilinx/DisplayPort/DisplayPort_1_4_ss2_1_rx_ex_v2020p1/hw/v_dp_rxss1_0_ex.srcs/sources_1/bd/dpss_zcu102_rx/ip/dpss_zcu102_rx_clk_wiz_0_1/dpss_zcu102_rx_clk_wiz_0_1_sim_netlist.vhdl
...
entity dpss_zcu102_rx_clk_wiz_0_1_dpss_zcu102_rx_clk_wiz_0_1_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of dpss_zcu102_rx_clk_wiz_0_1_dpss_zcu102_rx_clk_wiz_0_1_clk_wiz : entity is "dpss_zcu102_rx_clk_wiz_0_1_clk_wiz";
end dpss_zcu102_rx_clk_wiz_0_1_dpss_zcu102_rx_clk_wiz_0_1_clk_wiz;

architecture STRUCTURE of dpss_zcu102_rx_clk_wiz_0_1_dpss_zcu102_rx_clk_wiz_0_1_clk_wiz is
  signal clk_in1_dpss_zcu102_rx_clk_wiz_0_1 : STD_LOGIC;
  signal clk_out1_dpss_zcu102_rx_clk_wiz_0_1 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_dpss_zcu102_rx_clk_wiz_0_1
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_dpss_zcu102_rx_clk_wiz_0_1,
      O => clk_out1
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_dpss_zcu102_rx_clk_wiz_0_1,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_dpss_zcu102_rx_clk_wiz_0_1,
...
entity dpss_zcu102_rx_clk_wiz_0_1 is
  ...
  attribute NotValidForBitStream of dpss_zcu102_rx_clk_wiz_0_1 : entity is true;
end dpss_zcu102_rx_clk_wiz_0_1;

architecture STRUCTURE of dpss_zcu102_rx_clk_wiz_0_1 is
begin
inst: entity work.dpss_zcu102_rx_clk_wiz_0_1_dpss_zcu102_rx_clk_wiz_0_1_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      locked => locked,
